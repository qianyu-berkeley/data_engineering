...
class dynamodbAPI:
    ...
    def query_table(self, table_name, filter_key=None, 
                    filter_value=None, index_name=None):
    ...
    def query_table_allpages(self, table_name, filter_key=None,  
                             filter_value=None, index_name=None):
        """Perform a query operation on the table.
    ...
    def update_item(self, table_name, pk_name, pk_value, 
                    update_expression, expression_attr_values):
